...
kmuvcl::math::vec4f material_ambient  = kmuvcl::math::vec4f(0.464f, 0.393f, 0.094f, 1.0f); // 주변광
kmuvcl::math::vec4f material_diffuse  = kmuvcl::math::vec4f(1.464f, 1.393f, 1.094f, 1.0f); // 난반사
kmuvcl::math::vec4f material_specular = kmuvcl::math::vec4f(10.0f, 10.0f, 10.0f, 1.0f); //정반사
